package hn.proyectofinal.grupoone.views.certificaciones;
...
@Menu(order = 2, icon = LineAwesomeIconUrl.ADDRESS_BOOK_SOLID)
public class CertificacionesView extends Div implements AfterNavigationObserver {

    Grid<Person> grid = new Grid<>();

    public CertificacionesView() {
        addClassName("certificaciones-view");
        setSizeFull();
        grid.setHeight("100%");
